...
function PremiumCard({ id, name, description, selected, onToggle, preview }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["motion"].button, {
        ...
        onClick: ()=>onToggle(id),
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("group relative flex flex-col items-start w-full text-left p-6 rounded-[18px] border transition-colors duration-200 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-offset-2 overflow-hidden", selected ? "bg-[var(--theme-bg-card)] border-accent shadow-[0_0_20px_rgba(91,108,255,0.15)] ring-1 ring-accent" : "bg-[var(--theme-bg-card)] border-border-subtle hover:border-accent/40 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)]"),
...
//# sourceMappingURL=src_1afcsg-._.js.map